...
import { ResultCardRib } from "../../components/resultcard";


const Plusimage = require("../../assets/images/plus.png");

export default function RibCompresssion() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Text style={styles.pantingcount}>RIB COMPRESSION</Text>
      <Text style={styles.uploadvideo}>Upload a video of your dog here:</Text>
      ...
      {showCard && (
        <View style={styles.cardContainer}>
          <Card mode="video" feature= "rib" onPredictionResult={setResult} resetTrigger={!showCard} onTriggerChange={handlePlusCardChange}/>
        </View>
      )}
