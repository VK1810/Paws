...
import { ResultCardPanting } from "../../components/resultcard";
...
export default function Home() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Text style={styles.pantingcount}>PANTING COUNT</Text>
      ...
      {showCard && (
        <View style={styles.cardContainer}>
          <Card mode="video" feature= "panting" onPredictionResult={setResult} resetTrigger={!showCard} onTriggerChange={handlePlusCardChange}/>
        </View>
      )}
