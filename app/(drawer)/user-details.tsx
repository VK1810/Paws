...
export default function UserDetails() {
  ...
  return (
    <>
    <Stack.Screen name="notifications" options={{ presentation: 'modal', title: "User Details", headerShown: false }} />
    <View style={{ flex: 1 }}>
      <BackgroundBlob />
        <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
            ...
            <View style = {styles.informationSection}>
                ...
                <View style = {styles.informationWrapper}>
                    <Text style = {styles.informationHeading}>E-mail</Text>
                    <TextInput
                        style={styles.informationInput}
                        placeholder="Enter something..."
                        placeholderTextColor={colours.lightBeige}
                ...
                <View style = {styles.informationWrapper}>
                    <Text style = {styles.informationHeading}>Phone Number</Text>
                    <TextInput
                        style={styles.informationInput}
                        placeholder="Enter something..."
                        placeholderTextColor={colours.lightBeige}
